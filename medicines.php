  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
            ...
            <form method="post">
              <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                  ...
                  <input type="text" id="medicine_name" name="medicine_name" required="required" class="form-control form-control-sm rounded-0" />
                </div>
                <div class="col-lg-1 col-md-2 col-sm-2 col-xs-2">
                  <label>&nbsp;</label>
                  <button type="submit" id="save_medicine" name="save_medicine" class="btn btn-primary btn-sm btn-flat btn-block">Save</button>
                </div>
              </div>
            </form>
          </div>
      ...
      <section class="content">
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">All Treatment</h3>
        ...
        if (medicineName !== '') {
          $.ajax({
            ...
            success: function(count, status, xhr) {
              if (count > 0) {
                showCustomMessage("This treatment has already been stored. Please choose another name");

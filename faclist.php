    ...
    <div class="card card-outline card-primary rounded-0 shadow">
        ...
        <table class='table table-bordered'>
            <tr>
                <th>First Name</th>
                <th>Last Name</th>
                <th>Phone Number</th> <!-- Add this line for the phone number column -->
                <th>Action</th>
            </tr>";
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<td>" . $row['phone_number'] . "</td>"; // Display the phone number from the database
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            echo '<script type="text/javascript">
                            alert("Staff Name Successfully Deleted");
                            location="list.php";
                            </script>';
        }

...
<head>
  ...
  <title>Update Medicine - VET Clinical Information System in PHP</title>
      ...
      <section class="content">
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">Update Treatment</h3>
            ...
            <form method="post">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                  <input type="text" id="medicine_name" name="medicine_name" required="required" class="form-control form-control-sm rounded-0" value="<?php echo $row['medicine_name']; ?>" />
                </div>
